...
type ClusterIssuerTypeArgs struct {
	...
	// Desired state of the ClusterIssuer resource.
	Spec ClusterIssuerSpecInput `pulumi:"spec"`
	// Status of the ClusterIssuer. This is set and managed automatically.
...
// Desired state of the ClusterIssuer resource.
func (o ClusterIssuerTypeOutput) Spec() ClusterIssuerSpecOutput {
	return o.ApplyT(func (v ClusterIssuerType) ClusterIssuerSpec { return v.Spec }).(ClusterIssuerSpecOutput)
}
