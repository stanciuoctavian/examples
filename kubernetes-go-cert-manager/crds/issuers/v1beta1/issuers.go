...
type IssuerTypeArgs struct {
	...
	// Desired state of the Issuer resource.
	Spec IssuerSpecInput `pulumi:"spec"`
	// Status of the Issuer. This is set and managed automatically.
...
// Desired state of the Issuer resource.
func (o IssuerTypeOutput) Spec() IssuerSpecOutput {
	return o.ApplyT(func (v IssuerType) IssuerSpec { return v.Spec }).(IssuerSpecOutput)
}
