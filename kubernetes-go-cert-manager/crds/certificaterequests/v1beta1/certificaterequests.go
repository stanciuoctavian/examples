...
type CertificateRequestTypeArgs struct {
	...
	// Desired state of the CertificateRequest resource.
	Spec CertificateRequestSpecInput `pulumi:"spec"`
	// Status of the CertificateRequest. This is set and managed automatically.
...
// Desired state of the CertificateRequest resource.
func (o CertificateRequestTypeOutput) Spec() CertificateRequestSpecOutput {
	return o.ApplyT(func (v CertificateRequestType) CertificateRequestSpec { return v.Spec }).(CertificateRequestSpecOutput)
}
...
func (o CertificateRequestSpecOutput) Request() pulumi.StringOutput {
	return o.ApplyT(func (v CertificateRequestSpec) string { return v.Request }).(pulumi.StringOutput)
}
