...
type CertificateTypeArgs struct {
	...
	// Desired state of the Certificate resource.
	Spec CertificateSpecInput `pulumi:"spec"`
	// Status of the Certificate. This is set and managed automatically.
...
// Desired state of the Certificate resource.
func (o CertificateTypeOutput) Spec() CertificateSpecOutput {
	return o.ApplyT(func (v CertificateType) CertificateSpec { return v.Spec }).(CertificateSpecOutput)
}
...
func (o CertificateSpecPrivateKeyOutput) Algorithm() pulumi.StringPtrOutput {
	return o.ApplyT(func (v CertificateSpecPrivateKey) *string { return v.Algorithm }).(pulumi.StringPtrOutput)
}

// The private key cryptography standards (PKCS) encoding for this certificate's private key to be encoded in. If provided, allowed values are "pkcs1" and "pkcs8" standing for PKCS#1 and PKCS#8, respectively. Defaults to PKCS#1 if not specified.
func (o CertificateSpecPrivateKeyOutput) Encoding() pulumi.StringPtrOutput {
	return o.ApplyT(func (v CertificateSpecPrivateKey) *string { return v.Encoding }).(pulumi.StringPtrOutput)
}
...
func (o CertificateSpecPrivateKeyOutput) Size() pulumi.IntPtrOutput {
	return o.ApplyT(func (v CertificateSpecPrivateKey) *int { return v.Size }).(pulumi.IntPtrOutput)
}
...
func (o CertificateSpecPrivateKeyPtrOutput) Size() pulumi.IntPtrOutput {
	return o.ApplyT(func (v *CertificateSpecPrivateKey) *int {
		if v == nil {
			return nil
		}
		return v.Size
